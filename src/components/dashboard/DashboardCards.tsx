  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-2">
          <div className="min-w-0 flex-1 pr-2">
            <p className="text-xs font-medium text-gray-500 mb-1">Despesas do Mês</p>
      ...
      <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-2">
          <div className="min-w-0 flex-1 pr-2">
            <p className="text-xs font-medium text-gray-500 mb-1">Aportes do Mês</p>
            <p className="text-base sm:text-lg lg:text-2xl font-bold text-green-600 leading-tight">
      ...
      <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-2">
          <div className="min-w-0 flex-1 pr-2">
            <p className="text-xs font-medium text-gray-500 mb-1">Total em Caixa</p>
        ...
        <div>
          <span className="text-xs text-gray-500">Soma de todos os saldos</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-2">
          <div className="min-w-0 flex-1 pr-2">
            <p className="text-xs font-medium text-gray-500 mb-1">Próximos Vencimentos</p>
